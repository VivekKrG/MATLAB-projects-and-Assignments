...
% Last Modified by GUIDE v2.5 13-Mar-2019 10:58:58
...
global A=str2double(get(hObject,'String'))
...
operate= str2operator(get(hObject,'String'))
...
global B=str2double(get(hObject,'String'))
...
global result =A contents{get(hObject,'Value')} B
